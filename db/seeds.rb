...
for i in 0...50
  df_post_1 = sh_df.posts.create(subject: 'MAA Dinner', abstract: post_abstract, body: post_summary, active: 1, email_subject: 'MAA Dinner RSVP', email_body: 'I am interested in attending the MAA Dinner', contact_email: 'vince@yahoo.com', keywords: Keyword.where('id IN (1,2,3)'), start_date: 6.months.ago, end_date: 6.months.from_now)
  df_post_2 = sh_df.posts.create(subject: 'MAA Fair', abstract: post_abstract, body: post_summary, active: 1, email_subject: 'MAA Fair Looks Cool', email_body: 'Wow the fair looks cool how can I help?', contact_email: 'vince@yahoo.com', keywords: Keyword.where('id IN (4,5,6)'), start_date: 6.months.ago, end_date: 6.months.from_now)
  df_post_3 = sh_df.posts.create(subject: 'MAA Lesson', abstract: post_abstract, body: post_summary, active: 1, email_subject: 'MAA Lesson Attendance', email_body: 'I will be at the next MAA lession', contact_email: 'vince@yahoo.com', keywords: Keyword.where('id IN (7,8,9)'), start_date: 6.months.ago, end_date: 6.months.from_now)
